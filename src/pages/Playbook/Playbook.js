...
const PLAYBOOK_URL =
  'https://cdn2.hubspot.net/hubfs/2253693/Docs/DiversityPlaybook.pdf';
      ...
      <RouteTransition>
            ...
            <UIFlexRow>
              <UIFlex className="p-x-6 p-top-3 m-bottom-6">
                ...
                <p className="text-on-dark">
                  ...
                  at what works and what doesn’t work. You wouldn’t do that with
                  your product. Let’s do this the right way. Get the data. Adapt
                  the framework. Have the conversations. Set KPI’s. Build.
        ...
        <UILayout>
          <UISection className="text-center p-all-6">
            <h2>Interested in other opportunities?</h2>
            <p>There are multiple ways to promote diversity in your company.</p>
            <UIButton to="/get-involved/company">Get Involved</UIButton>
          </UISection>
        </UILayout>
      </RouteTransition>
    );
