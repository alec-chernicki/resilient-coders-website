          ...
          <UIFlexRow align="center">
            <UIFlex basis="30%">
              <p className="text-on-dark text-constrained">
                Micah was a young, aspiring coder, when we met him. Watch the
                crowdfunding video with which we were able to send him and
                another one of our coders, Fredy Melo, to Startup Institute.
                Today, Micah is a full stack web developer at the Boston Globe.
                As he says in the clip, he's just trying to make somebody to
                look up to.
              </p>
              <UIButton
      ...
      <RouteTransition>
            ...
            <UIFlexRow>
              <UIFlex className="index-10 pull-up-offset-3 hero-card-first">
                <UICard className="p-all-6 pull-up-3 with-shadow">
                  <h1>Our Mission</h1>
                  <p>
                    We believe in social justice through economic empowerment,
                    and in the opportunity for meritocracy in tech. We think
                    holistically about the school-to-workforce pipeline,
                    offering a chaining series of programs that guide our
                    hackers through the extensive journey of learning web
                    development.
                  </p>
                  <p>
                    This isn't about one-off camps or hackathons. This is about
                    <span className="strong">&nbsp;meaningful change.</span>
                  </p>
                </UICard>
              </UIFlex>
              <UIFlex className="pull-up-offset-6 index-10 hero-card-second">
                <UIImage
                  type="cover"
                  src={homeImage}
                  className="pull-up-6 with-shadow"
                />
              </UIFlex>
            </UIFlexRow>
          </UISection>
            ...
            <UIFlexRow className="position-relative index-1">
              <UIFlex basis="50%">
                <div className="p-x-6 p-y-12 text-center">
                  ...
                  <UIButton to="/bootcamp/roster">See all students</UIButton>
                </div>
              </UIFlex>
            </UIFlexRow>
          </UISection>
        ...
        <UILayout>
          <UISection>
            <UICard
              use="secondary"
              className="text-center p-all-6 pull-up-6 with-shadow"
            >
        ...
        <UILayout use="tertiary" className="p-bottom-20 p-top-20">
          <UISection className="text-center index-2">
            ...
            <p className="text-constrained text-on-dark m-x-auto">
              We're on a mission to make computer science a meritocracy. Help us
              make the Boston tech community more diverse and inclusive.
            </p>
