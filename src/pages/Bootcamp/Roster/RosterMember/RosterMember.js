    ...
    return (
      <UILayout className="p-top-6 p-bottom-6">
        <UISection className="text-center">
          <h1 className="m-bottom-0 text-darkest">Portfolio Website</h1>
          <div className="divider divider__red " />
          <a styleName="website" target="_blank" href={portfolioUrl}>
      ...
      <RouteTransition>
        <UILayout>
          ...
          <UISection className="p-top-of-page p-bottom-6 index-2">
            ...
            >
              <UIIcon image={leftArrowImage} align="text-bottom" />
        ...
        <UILayout>
          <UISection className="text-center p-all-6">
            <h2>Want to see more students?</h2>
            ...
            <UIButton to="/bootcamp/roster">View all students</UIButton>
          </UISection>
        </UILayout>
      </RouteTransition>
    );
