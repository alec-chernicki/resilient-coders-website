    ...
    return (
      <RouteTransition>
        ...
        <UILayout use="tertiary">
          ...
          <UISection
            className="p-bottom-6 p-top-of-page text-center p-x-2 index-2"
            flush={false}
          >
            <h1>The Roster</h1>
            <div className="divider divider__red" />
            <p className="text-constrained text-on-dark m-x-auto">
              Bootcampers meet daily, for eight weeks, to learn semantically
              structured HTML, responsive CSS, JavaScript, jQuery, git, and
              more. Before graduating, they will have built, and pushed to
              GitHub, actual client work that showcases these aptitudes. From{' '}
              <a href="/bootcamp">Bootcamp</a>, mentorship, and Resilient Lab,
              through additional on-the-job support, we ensure that our coders
              are successful at at their first technical job.
            </p>
            <UIButton
