...
const FORM_URL = '/api/subscribe/volunteer';
      ...
      <UILayout className="p-top-of-page p-bottom-6">
        ...
        <UISection className="index-2">
          <UIFlexRow>
            ...
            <UIFlex>
              <EmailFormLong title="Get more information" formUrl={FORM_URL} />
            </UIFlex>
          </UIFlexRow>
        </UISection>
      </UILayout>
        ...
        <UISection className="p-y-6">
          <UICard className="p-all-6 text-center m-bottom-6 with-shadow">
            ...
            <p className="text-constrained m-x-auto">
              ...
              &nbsp;Once you've signed up, drop by, we want to meet you. Our
              Community Hours are Tuesdays and Thursdays, at 50 Milk St. Boston
              MA, 5th floor, between 3:30 and 6 &nbsp;
              <a href="mailto:leon@resilientcoders.org?subject=Mentor%20stopping%20by">
                Email Leon
              </a>
              &nbsp; if you're planning on stopping by, so we know to expect
              you.
            </p>
            <UIButton
              target="_blank"
            ...
            <UIFlex>
              <UICard className="p-all-6">
                ...
                <ul className="m-bottom-6">
                  <li>
                    <p>
                      &#183; Drop-in mentorship at Community Hours on Tuesdays
                      and Thursdays.
                    </p>
                  </li>
                  <li>
                    <p>
                      &#183; Bootcamp mentorship at Community Hours on Tuesdays
                      and Thursdays.
                    </p>
                  </li>
                  <li>
                    <p>
                      &#183; 1-on-1 mentorship of an alumni who is working, or
                      looking for work.
                    </p>
                  </li>
                  <li>
                    <p>&#183; One-off lightning talks, at Community Hours.</p>
                  </li>
                  <li>
                ...
                <ul className="m-bottom-6">
                  <li>
                    <p>&#183; Technical guest blogging</p>
                  </li>
                  <li>
                    <p>&#183; PR, helping us attract press</p>
                  </li>
                </ul>

                <h2>Talent Placement</h2>
                <ul className="m-bottom-6">
                  <li>
                    <p>
                      &#183; Help students develop, hone resumes and cover
                      letters.
                    </p>
                  </li>
                  <li>
                    <p>
                      &#183; Join us in identifying and/or brokering
