          ...
          <UISection>
            <div className="footer-container-upper">
              <div className="footer-container-links">
                ...
                <Link className="text-on-dark" to="/bootcamp">
                  About
                </Link>
                <Link className="text-on-dark" to="/bootcamp/roster">
                  Roster
                </Link>
              </div>
              <div className="footer-container-links">
                <h3 className="text-white">Lab</h3>
                <Link className="text-on-dark" to="/lab">
                  About
                </Link>
              </div>
              <div className="footer-container-links">
                <h3 className="text-white">Get Involved</h3>
                <Link className="text-on-dark" to="/get-involved/student">
                  Students
                </Link>
                <Link className="text-on-dark" to="/get-involved/volunteer">
                  Volunteers
                </Link>
                <Link className="text-on-dark" to="/get-involved/company">
                  Companies
                </Link>
              </div>
              <div className="footer-container-info">
                ...
                <p className="text-on-dark">
                  Photography, video, and music by&nbsp;
                  <a
                    className="accent-link-underline text-white"
